...
require(tidyr)
setwd("C:/Users/spers003/Desktop/Genome Size Evolution/Animal Genome Size Database C-Values")
...
###############################################################################################################
###             Getting Subsets of the Mean and Median C-Values from the Full Osteichthyes Data             ###
###############################################################################################################

CVal_ChromNum_Appended<-read.csv("AGSD_CVal_Means_and_Medians_Osteichthyes.csv")
...
Syngnathiformes<-subset(CVal_ChromNum_Appended,CVal_ChromNum_Appended$Order=="Syngnathiformes")
write.csv(Syngnathiformes,"AGSD_Syngnathiformes.csv")

### Siluriformes

Siluriformes<-subset(CVal_ChromNum_Appended,CVal_ChromNum_Appended$Order=="Siluriformes")
write.csv(Siluriformes,"AGSD_Siluriformes.csv")

### Cyprinodontiformes

Cyprinodontiformes<-subset(CVal_ChromNum_Appended,CVal_ChromNum_Appended$Order=="Cyprinodontiformes")
write.csv(Cyprinodontiformes,"AGSD_Cyprinodontiformes.csv")
